...
locals {
  github-repo = "https://github.com/asumankamberoglu/phonebookswarm.git"
  github-file-url = "https://raw.githubusercontent.com/asumankamberoglu/phonebookswarm/main/"
}
...
resource "aws_ecr_repository" "ecr-repo" {
  name                 = "asuman-repo/phonebook-app"
